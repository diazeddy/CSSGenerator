...
import PreviewTextRadius from "../PreviewBox/PreviewTextRadius";

export const TextShadowGenerator = () => {
    const [horizontalShadowLength, setHorizontalShadowLength] = useState(-20);
    const [verticalShadowLength, setVerticalShadowLength] = useState(0);
    ...
    const textShadow = `${horizontalShadowLength}px ${verticalShadowLength}px ${blurRadius}px rgba(${shadowColor[0]}, ${shadowColor[1]}, ${shadowColor[2]}, ${shadowOpacity})`;

    const handleCopy = async () => {
        const success = await copyToClipboard("text-shadow:" + textShadow);
        setCopied(success);
        if (success) {
    ...
    <div className="lg:flex gap-4">
        <div className="w-full mb-4 lg:flex-grow-0 flex-shrink-0 lg:w-1/3flex-grow-0 flex-shrink-0 w-1/3">
        ...
        <div className="w-full lg:flex-grow-0 flex-shrink-0 lg:w-2/3 flex items-center justify-center flex-col">
            <PreviewTextRadius textShadow={textShadow} />
